  ...
  const branchIntelligence = createNode(
    ...
    [
      createNode('ai-01', '第 1 章 · AI 是什么',
        ...
        '约 2988 字',
        [
          createNode('ai-01-1', '§ 1.1 · 弱 AI · ANI', '狭义人工智能——今天所有能用的 AI 都属于这一类。', '788 字', [], { href: 'chapters/ai/01-1-ani.html' }),
          createNode('ai-01-2', '§ 1.2 · 通用 AI · AGI', '像人类一样能做任何智力任务的 AI，尚未实现。', '691 字', [], { href: 'chapters/ai/01-2-agi.html' }),
          createNode('ai-01-3', '§ 1.3 · 超级 AI · ASI', '在所有领域全面超越人类的假想 AI。', '722 字', [], { href: 'chapters/ai/01-3-asi.html' }),
          createNode('ai-01-4', '§ 1.4 · AI 的四种能力', '感知 / 理解 / 决策 / 生成——AI 做的事都可以归到这四类。', '787 字', [], { href: 'chapters/ai/01-4-abilities.html' })
        ],
      ...
      createNode('ai-02', '第 2 章 · 三个圈',
        ...
        '约 4576 字',
        [
          createNode('ai-02-1', '§ 2.1 · 人工智能 · AI', '最外圈——所有让机器有智能行为的技术总称。', '787 字', [], { href: 'chapters/ai/02-1-ai.html' }),
          createNode('ai-02-2', '§ 2.2 · 机器学习 · ML', '让机器从数据里学规律的方法集合。', '1036 字', [], { href: 'chapters/ai/02-2-ml.html' }),
          createNode('ai-02-3', '§ 2.3 · 深度学习 · DL', '用多层神经网络的机器学习——是 ML 的子集。', '948 字', [], { href: 'chapters/ai/02-3-dl.html' }),
          createNode('ai-02-4', '§ 2.4 · 生成式 AI · GenAI', '专门"造"内容的 AI——文字、图片、视频。', '774 字', [], { href: 'chapters/ai/02-4-genai.html' }),
          createNode('ai-02-5', '§ 2.5 · 大语言模型 · LLM', '基于 Transformer 的巨型语言模型——ChatGPT 的核心。', '1031 字', [], { href: 'chapters/ai/02-5-llm.html' })
        ],
      ...
      createNode('ai-03', '第 3 章 · 简史',
        ...
        '约 2.1 万字',
        [
          createNode('ai-03-early', '§ 3.1 · 早期探索 · 1943-1956', '神经元数学模型、图灵测试、达特茅斯会议。', '4296 字', [], { href: 'chapters/ai/03-history.html#early' }),
          createNode('ai-03-expert', '§ 3.2 · 专家系统与寒冬 · 1969-1993', '感知机撞墙、专家系统兴衰、两次 AI 寒冬。', '4296 字', [], { href: 'chapters/ai/03-history.html#expert-winter' }),
          createNode('ai-03-dl', '§ 3.3 · 深度学习革命 · 1997-2017', '深蓝、Hinton 复活神经网络、AlexNet、AlphaGo、Transformer。', '4296 字', [], { href: 'chapters/ai/03-history.html#dl-revolution' }),
          createNode('ai-03-llm', '§ 3.4 · 大模型时代 · 2018-2026', 'BERT/GPT、ChatGPT、多模态、推理模型、Agent 元年。', '4296 字', [], { href: 'chapters/ai/03-history.html#llm-era' }),
          createNode('ai-03-lessons', '§ 3.5 · 历史启示', '三次浪潮的共同规律——技术、算力、数据缺一不可。', '4296 字', [], { href: 'chapters/ai/03-history.html#lessons' })
        ],
      ...
      createNode('ai-04', '第 4 章 · 机器学习',
        ...
        '约 6502 字',
        [
          createNode('ai-04-1', '§ 4.1 · 监督学习', '老师批改作业式学习——工业界用得最多。', '1383 字', [], { href: 'chapters/ai/04-1-supervised.html' }),
          createNode('ai-04-2', '§ 4.2 · 无监督学习', '自己找规律——聚类、降维、异常检测。', '1107 字', [], { href: 'chapters/ai/04-2-unsupervised.html' }),
          createNode('ai-04-3', '§ 4.3 · 强化学习', '试错式学习——下棋 AI、自动驾驶、机器人。', '1399 字', [], { href: 'chapters/ai/04-3-reinforcement.html' }),
          createNode('ai-04-4', '§ 4.4 · 自监督学习', '让数据自己教自己——大模型预训练的核心。', '1310 字', [], { href: 'chapters/ai/04-4-self-supervised.html' }),
          createNode('ai-04-5', '§ 4.5 · 特征/标签/过拟合', 'ML 的三个基础术语——ABC 级别的必备概念。', '1303 字', [], { href: 'chapters/ai/04-5-overfitting.html' })
        ],
      ...
      createNode('ai-05', '第 5 章 · 神经网络',
        ...
        '约 1.6 万字',
        [
          createNode('ai-05-1', '§ 5.1 · 神经元', '加权求和 + 激活函数——一个"人工神经元"的全部。', '2528 字', [], { href: 'chapters/ai/05-1-neuron.html' }),
      ...
      createNode('ai-06', '第 6 章 · 训练三部曲',
        ...
        '约 9176 字',
        [
          createNode('ai-06-1', '§ 6.1 · 数据 · Dataset', '规模+质量+多样性、训练/验证/测试三集分离。', '1788 字', [], { href: 'chapters/ai/06-1-dataset.html' }),
          createNode('ai-06-2', '§ 6.2 · 模型 · Model', '参数量、架构、初始化、超参数——待训练的神经网络。', '1670 字', [], { href: 'chapters/ai/06-2-model.html' }),
          createNode('ai-06-3', '§ 6.3 · 损失 & 梯度下降', '交叉熵/MSE + 蒙眼下山——让损失越来越小。', '1890 字', [], { href: 'chapters/ai/06-3-loss.html' }),
          createNode('ai-06-4', '§ 6.4 · 预训练', '几十T 语料预测下一词——基座大模型的诞生。', '1879 字', [], { href: 'chapters/ai/06-4-pretrain.html' }),
          createNode('ai-06-5', '§ 6.5 · SFT · RLHF · DPO 对齐', '学对话 → 学偏好 → 让模型讨人喜欢。', '1949 字', [], { href: 'chapters/ai/06-5-rlhf.html' })
        ],
      ...
      createNode('ai-07', '第 7 章 · Transformer',
        ...
        '约 1.3 万字',
        [
          createNode('ai-07-1', '§ 7.1 · Attention 注意力', '每个词都能"看到"其他所有词——图书馆式加权。', '2711 字', [], { href: 'chapters/ai/07-1-attention.html' }),
  ...
  const branchNetwork = createNode(
    ...
    [
      createNode('net-01', '第 1 章 · 网络是什么',
        ...
        '约 7823 字',
        [
          createNode('net-01-1', '§ 1.1 · 主机 Host', '每台联网设备都叫主机——从手机到服务器。', '1179 字', [], { href: 'chapters/network/01-1-host.html' }),
          createNode('net-01-2', '§ 1.2 · 协议 Protocol', '协议 = 通信的"共同语言"——TCP/IP、HTTP、DNS。', '1327 字', [], { href: 'chapters/network/01-2-protocol.html' }),
          createNode('net-01-3', '§ 1.3 · 地址 Address', 'IP + MAC + 端口——网络世界的三种"地址"。', '1130 字', [], { href: 'chapters/network/01-3-address.html' }),
          createNode('net-01-4', '§ 1.4 · 客户端 vs 服务器', '谁发起、谁响应——互联网的基本分工模式。', '1240 字', [], { href: 'chapters/network/01-4-client-server.html' }),
          createNode('net-01-5', '§ 1.5 · 数据包 Packet', '把数据切成小包裹分批传输——为什么不整块发。', '1552 字', [], { href: 'chapters/network/01-5-packet.html' }),
          createNode('net-01-6', '§ 1.6 · 带宽/时延/丢包', '衡量网络好坏的三个核心指标。', '1395 字', [], { href: 'chapters/network/01-6-metrics.html' })
        ],
      ...
      createNode('net-02', '第 2 章 · 分层模型',
        ...
        '约 3288 字',
        [
          createNode('net-02-1', '§ 2.1 · OSI 七层模型', '国际标准化组织的"理想分层"——教学必学。', '1318 字', [], { href: 'chapters/network/02-1-osi.html' }),
          createNode('net-02-2', '§ 2.2 · TCP/IP 四层模型', '互联网实际在用的模型——比 OSI 简洁。', '823 字', [], { href: 'chapters/network/02-2-tcpip.html' }),
          createNode('net-02-3', '§ 2.3 · 分层实战', '把协议"对号入座"——每个协议在哪一层。', '1147 字', [], { href: 'chapters/network/02-3-layers-in-action.html' })
        ],
      ...
      createNode('net-03', '第 3 章 · 关键协议',
        ...
        '约 3688 字',
        [
          createNode('net-03-1', '§ 3.1 · HTTP / HTTPS', '浏览网页的协议——请求响应、状态码、Cookie、加密。', '1369 字', [], { href: 'chapters/network/03-1-http.html' }),
          createNode('net-03-2', '§ 3.2 · TCP', '可靠传输——三次握手、四次挥手、流量控制。', '1074 字', [], { href: 'chapters/network/03-2-tcp.html' }),
          createNode('net-03-3', '§ 3.3 · UDP', '快速但不保证——视频、直播、游戏为什么用它。', '871 字', [], { href: 'chapters/network/03-3-udp.html' }),
  ...
  const branchInterface = createNode(
    ...
    [
      ...
      createNode('gui-02', '第 2 章 · 界面是怎么画出来的',
        ...
        '约 1.7 万字',
        [
          createNode('gui-02-1', '§ 2.1 · 像素与分辨率', '像素、DPI、逻辑像素 vs 物理像素、@2x 图为什么存在。', '3487 字', [], { href: 'chapters/gui/02-1-pixel.html' }),
          createNode('gui-02-2', '§ 2.2 · 位图 vs 矢量', 'PNG/JPG 放大就糊，SVG 无限放大不糊——差在哪。', '3430 字', [], { href: 'chapters/gui/02-2-bitmap-vector.html' }),
          createNode('gui-02-3', '§ 2.3 · 颜色与色彩空间', 'RGB、HSL、sRGB vs P3、透明度与混色。', '3368 字', [], { href: 'chapters/gui/02-3-color.html' }),
          createNode('gui-02-4', '§ 2.4 · 渲染管线', '解析 → 布局 → 绘制 → 合成——一帧画面的四步流水线。', '3163 字', [], { href: 'chapters/gui/02-4-render-pipeline.html' }),
          createNode('gui-02-5', '§ 2.5 · GPU 合成与 60fps', '为什么动画会卡、为什么 transform 比 top 快。', '3086 字', [], { href: 'chapters/gui/02-5-gpu-60fps.html' })
        ],
