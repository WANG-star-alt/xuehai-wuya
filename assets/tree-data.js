    ...
    [
      ...
      createNode('net-08', '第 8 章 · 网络安全',
        ...
        [
          ...
          createNode('net-08-3', '§ 8.3 · Web 攻击', 'XSS、CSRF、SQL 注入、SSRF——最常见的四种打法。', '8393 字', [], { href: 'chapters/network/08-3-web-attacks.html', spec: 'pass'}),
          createNode('net-08-4', '§ 8.4 · DDoS 与防护', '流量型 vs 应用型攻击、清洗中心、限流策略。', '9792 字', [], { href: 'chapters/network/08-4-ddos.html', spec: 'pass'}),
          createNode('net-08-5', '§ 8.5 · VPN 与代理', 'VPN、正向/反向代理、隧道协议——流量怎么绕路。', '9682 字', [], { href: 'chapters/network/08-5-vpn-proxy.html', spec: 'pass'}),
