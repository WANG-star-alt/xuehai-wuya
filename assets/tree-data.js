  ...
  const branchIntelligence = createNode(
    ...
    [
      ...
      createNode('ai-02', '第 2 章 · 三个圈',
        ...
        '约 3.0 万字',
        [
          createNode('ai-02-1', '§ 2.1 · 人工智能 · AI', '最外圈——所有让机器有智能行为的技术总称。', '5258 字', [], { href: 'chapters/ai/02-1-ai.html' }),
          createNode('ai-02-2', '§ 2.2 · 机器学习 · ML', '让机器从数据里学规律的方法集合。', '6554 字', [], { href: 'chapters/ai/02-2-ml.html' }),
          createNode('ai-02-3', '§ 2.3 · 深度学习 · DL', '用多层神经网络的机器学习——是 ML 的子集。', '5910 字', [], { href: 'chapters/ai/02-3-dl.html' }),
          createNode('ai-02-4', '§ 2.4 · 生成式 AI · GenAI', '专门"造"内容的 AI——文字、图片、视频。', '5531 字', [], { href: 'chapters/ai/02-4-genai.html' }),
          createNode('ai-02-5', '§ 2.5 · 大语言模型 · LLM', '基于 Transformer 的巨型语言模型——ChatGPT 的核心。', '7188 字', [], { href: 'chapters/ai/02-5-llm.html' })
        ],
      ...
      createNode('ai-04', '第 4 章 · 机器学习',
        ...
        '约 4.3 万字',
        [
          createNode('ai-04-1', '§ 4.1 · 监督学习', '老师批改作业式学习——工业界用得最多。', '8180 字', [], { href: 'chapters/ai/04-1-supervised.html' }),
          createNode('ai-04-2', '§ 4.2 · 无监督学习', '自己找规律——聚类、降维、异常检测。', '8071 字', [], { href: 'chapters/ai/04-2-unsupervised.html' }),
          createNode('ai-04-3', '§ 4.3 · 强化学习', '试错式学习——下棋 AI、自动驾驶、机器人。', '9494 字', [], { href: 'chapters/ai/04-3-reinforcement.html' }),
          createNode('ai-04-4', '§ 4.4 · 自监督学习', '让数据自己教自己——大模型预训练的核心。', '7732 字', [], { href: 'chapters/ai/04-4-self-supervised.html' }),
          createNode('ai-04-5', '§ 4.5 · 特征/标签/过拟合', 'ML 的三个基础术语——ABC 级别的必备概念。', '9032 字', [], { href: 'chapters/ai/04-5-overfitting.html' })
        ],
      ...
      createNode('ai-06', '第 6 章 · 训练三部曲',
        ...
        '约 3.9 万字',
        [
          createNode('ai-06-1', '§ 6.1 · 数据 · Dataset', '规模+质量+多样性、训练/验证/测试三集分离。', '8372 字', [], { href: 'chapters/ai/06-1-dataset.html' }),
          createNode('ai-06-2', '§ 6.2 · 模型 · Model', '参数量、架构、初始化、超参数——待训练的神经网络。', '6635 字', [], { href: 'chapters/ai/06-2-model.html' }),
          createNode('ai-06-3', '§ 6.3 · 损失 & 梯度下降', '交叉熵/MSE + 蒙眼下山——让损失越来越小。', '7987 字', [], { href: 'chapters/ai/06-3-loss.html' }),
          createNode('ai-06-4', '§ 6.4 · 预训练', '几十T 语料预测下一词——基座大模型的诞生。', '7029 字', [], { href: 'chapters/ai/06-4-pretrain.html' }),
          createNode('ai-06-5', '§ 6.5 · SFT · RLHF · DPO 对齐', '学对话 → 学偏好 → 让模型讨人喜欢。', '8800 字', [], { href: 'chapters/ai/06-5-rlhf.html' })
        ],
  ...
  const branchNetwork = createNode(
    ...
    [
      createNode('net-01', '第 1 章 · 网络是什么',
        ...
        '约 4.2 万字',
        [
          createNode('net-01-1', '§ 1.1 · 主机 Host', '每台联网设备都叫主机——从手机到服务器。', '6690 字', [], { href: 'chapters/network/01-1-host.html' }),
          createNode('net-01-2', '§ 1.2 · 协议 Protocol', '协议 = 通信的"共同语言"——TCP/IP、HTTP、DNS。', '7816 字', [], { href: 'chapters/network/01-2-protocol.html' }),
          createNode('net-01-3', '§ 1.3 · 地址 Address', 'IP + MAC + 端口——网络世界的三种"地址"。', '7067 字', [], { href: 'chapters/network/01-3-address.html' }),
          createNode('net-01-4', '§ 1.4 · 客户端 vs 服务器', '谁发起、谁响应——互联网的基本分工模式。', '5949 字', [], { href: 'chapters/network/01-4-client-server.html' }),
          createNode('net-01-5', '§ 1.5 · 数据包 Packet', '把数据切成小包裹分批传输——为什么不整块发。', '7677 字', [], { href: 'chapters/network/01-5-packet.html' }),
          createNode('net-01-6', '§ 1.6 · 带宽/时延/丢包', '衡量网络好坏的三个核心指标。', '7171 字', [], { href: 'chapters/network/01-6-metrics.html' })
        ],
      ...
      createNode('net-02', '第 2 章 · 分层模型',
        ...
        '约 2.2 万字',
        [
          createNode('net-02-1', '§ 2.1 · OSI 七层模型', '国际标准化组织的"理想分层"——教学必学。', '9006 字', [], { href: 'chapters/network/02-1-osi.html' }),
          createNode('net-02-2', '§ 2.2 · TCP/IP 四层模型', '互联网实际在用的模型——比 OSI 简洁。', '6769 字', [], { href: 'chapters/network/02-2-tcpip.html' }),
          createNode('net-02-3', '§ 2.3 · 分层实战', '把协议"对号入座"——每个协议在哪一层。', '6209 字', [], { href: 'chapters/network/02-3-layers-in-action.html' })
        ],
      ...
      createNode('net-03', '第 3 章 · 关键协议',
        ...
        '约 2.7 万字',
        [
          createNode('net-03-1', '§ 3.1 · HTTP / HTTPS', '浏览网页的协议——请求响应、状态码、Cookie、加密。', '9052 字', [], { href: 'chapters/network/03-1-http.html' }),
          createNode('net-03-2', '§ 3.2 · TCP', '可靠传输——三次握手、四次挥手、流量控制。', '9072 字', [], { href: 'chapters/network/03-2-tcp.html' }),
