  ...
  const branchElec = createNode(
    ...
    [
      createNode('elec-01', '第 1 章 · 安全第一课',
        ...
        '待撰写',
        [
          createNode('elec-01-1', '§ 1.1 · 电为什么会电到人', '电流穿过身体才危险，几毫安开始麻、多少毫安要命。', '待撰写', []),
          createNode('elec-01-2', '§ 1.2 · 火线、零线、地线', '三根线各干什么，为什么只碰零线通常不电人。', '待撰写', []),
          createNode('elec-01-3', '§ 1.3 · 动手前的断电三步', '关对闸、验电、告知家人，确认真没电才伸手。', '待撰写', []),
          createNode('elec-01-4', '§ 1.4 · 验电笔怎么用', '试电笔的正确握法、误报场景，两点交叉复验法。', '待撰写', []),
          createNode('elec-01-5', '§ 1.5 · 触电与电火灾急救', '先断电再救人、绝缘物分离、电火灾绝不能泼水。', '待撰写', []),
          createNode('elec-01-6', '§ 1.6 · 红线清单：绝不自己碰', '进户线、电表、总闸上游、渗水墙体——直接叫电工。', '待撰写', [])
        ]
      ),
