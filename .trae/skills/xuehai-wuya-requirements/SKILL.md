...
- **2026-08-01**: 三个分支的**第三层子篇节点全部补齐**（智能篇 14 章 / 网络篇 10 章 / 界面篇 10 章，共 34 章 · 170+ 子篇）。未写文章的子节点不带 `href`，圆点显示浅灰色；写完后加 `href` 即自动变深绿色。

## 待办事项

- [ ] 界面篇第 1-10 章（全部未上线，骨架已建好）
- [ ] 智能篇第 8-14 章（未上线）
- [ ] 网络篇第 3 章剩余子篇: DNS / IP / 其他协议
- [ ] 网络篇第 4-10 章（未上线）
- [x] ~~智能篇第 5-7 章~~（2026-07-26 已上线，各拆 5-6 个独立子篇）
